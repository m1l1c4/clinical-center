...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/clinic/deleteRoom/*" ,"/deleteDoctor" ,"/findDoctors" , "/login", "/clinic/changeNameOfType" ,"/clinic/searchOneType/*","/register", "/clinic", "/addAdmin", "/codebook",
